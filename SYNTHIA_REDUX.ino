...
AudioSynthWaveform       waveformC2;     //xy=340,61
AudioSynthWaveform       waveformC1;     //xy=341,20
AudioSynthWaveform       waveformC3;     //xy=342,103
AudioSynthWaveform       waveformD3;     //xy=345,327
AudioSynthWaveform       waveformD1;     //xy=346,251
AudioSynthWaveform       waveformD2;     //xy=346,288
AudioSynthWaveform       waveformE1;     //xy=350,450
AudioSynthWaveform       waveformE2;     //xy=352,487
AudioSynthWaveform       waveformE3;     //xy=353,523
AudioSynthWaveform       waveformFS2;    //xy=355,696
AudioSynthWaveform       waveformFS3;    //xy=355,732
AudioSynthWaveform       waveformFS1;    //xy=356,660
AudioSynthWaveform       waveformGS1;    //xy=361,869
AudioSynthWaveform       waveformGS3;    //xy=361,945
AudioSynthWaveform       waveformGS2;    //xy=363,907
AudioSynthWaveform       waveformAS1;    //xy=370,1094
AudioSynthWaveform       waveformAS3;    //xy=370,1166
AudioSynthWaveform       waveformAS2;    //xy=371,1131
AudioSynthWaveform       waveformCS1;    //xy=483,134
AudioSynthWaveform       waveformCS2;    //xy=488,174
AudioSynthWaveform       waveformCS3;    //xy=490,215
AudioSynthWaveform       waveformDS1;    //xy=496,340
AudioSynthWaveform       waveformDS3;    //xy=497,415
AudioSynthWaveform       waveformF2;     //xy=497,591
AudioSynthWaveform       waveformDS2;    //xy=498,377
AudioSynthWaveform       waveformF1;     //xy=498,554
AudioSynthWaveform       waveformF3;     //xy=501,629
AudioSynthWaveform       waveformG1;     //xy=504,759
AudioSynthWaveform       waveformG2;     //xy=504,796
AudioSynthWaveform       waveformG3;     //xy=506,835
AudioMixer4              mixerC1;        //xy=518,53
AudioMixer4              mixerE1;        //xy=517,485
AudioSynthWaveform       waveformA1;     //xy=516,976
AudioSynthWaveform       waveformA2;     //xy=517,1014
AudioMixer4              mixerD1;        //xy=521,280
AudioSynthWaveform       waveformA3;     //xy=518,1052
AudioMixer4              mixerFS;        //xy=522,690
AudioSynthWaveform       waveformB2;     //xy=525,1231
AudioSynthWaveform       waveformB1;     //xy=526,1191
AudioSynthWaveform       waveformB3;     //xy=526,1270
AudioMixer4              mixerGS;        //xy=532,902
AudioMixer4              mixerAS;        //xy=534,1123
AudioMixer4              mixerCS;        //xy=647,169
AudioMixer4              mixerDS;        //xy=653,377
AudioEffectEnvelope      env1;           //xy=657,52
AudioEffectEnvelope      env5;           //xy=657,487
AudioMixer4              mixerF1;        //xy=661,586
AudioMixer4              mixerG1;        //xy=665,790
AudioEffectEnvelope      env9;           //xy=669,903
AudioMixer4              mixerA1;        //xy=672,1008
AudioEffectEnvelope      env3;           //xy=679,280
AudioEffectEnvelope      env11;          //xy=682,1120
AudioEffectEnvelope      env7;           //xy=686,682
AudioMixer4              mixerB1;        //xy=688,1231
AudioEffectEnvelope      env2;           //xy=782,170
AudioEffectEnvelope      env4;           //xy=790,374
AudioEffectEnvelope      env6;           //xy=804,590
AudioEffectEnvelope      env8;           //xy=805,793
AudioEffectEnvelope      env10;          //xy=809,1008
AudioEffectEnvelope      env12;          //xy=832,1232
AudioSynthNoisePink      noise1;         //xy=960,772
AudioMixer4              mixerKeys1;     //xy=966,286
AudioMixer4              mixerKeys2;     //xy=969,568
AudioMixer4              mixerKeys3;     //xy=973,936
AudioEffectEnvelope      env13;          //xy=1042,684
AudioMixer4              mixerKeys4;     //xy=1134,575
AudioEffectFreeverb      freeverb1;      //xy=1273,491
AudioFilterStateVariable filter1;        //xy=1337,583
AudioMixer4              mixerFilter1;   //xy=1538,590
AudioMixer4              mixerFeedback;  //xy=1732,609
AudioEffectDelay         delay1;         //xy=1741,460
AudioMixer4              mixerDelay1;    //xy=1902,424
AudioMixer4              mixerDelay2;    //xy=1902,493
AudioMixer4              mixerDryWet1;   //xy=2207,581
AudioMixer4              mixerDryWet2;   //xy=2207,653
AudioOutputI2S           i2s1;           //xy=2376,623
AudioAnalyzePeak         peak1;          //xy=2376,769
...
AudioConnection          patchCord67(freeverb1, 0, filter1, 0);
AudioConnection          patchCord68(freeverb1, 0, mixerFilter1, 3);
AudioConnection          patchCord69(filter1, 0, mixerFilter1, 0);
AudioConnection          patchCord70(filter1, 1, mixerFilter1, 1);
AudioConnection          patchCord71(filter1, 2, mixerFilter1, 2);
AudioConnection          patchCord72(mixerFilter1, 0, mixerFeedback, 0);
AudioConnection          patchCord73(mixerFeedback, delay1);
AudioConnection          patchCord74(mixerFeedback, 0, mixerDryWet1, 0);
AudioConnection          patchCord75(mixerFeedback, 0, mixerDryWet2, 0);
AudioConnection          patchCord76(delay1, 0, mixerDelay1, 0);
AudioConnection          patchCord77(delay1, 1, mixerDelay2, 0);
AudioConnection          patchCord78(delay1, 2, mixerDelay1, 1);
AudioConnection          patchCord79(delay1, 3, mixerDelay2, 1);
AudioConnection          patchCord80(delay1, 4, mixerDelay1, 2);
AudioConnection          patchCord81(delay1, 5, mixerDelay2, 2);
AudioConnection          patchCord82(delay1, 6, mixerDelay1, 3);
AudioConnection          patchCord83(delay1, 7, mixerDelay2, 3);
AudioConnection          patchCord84(mixerDelay1, 0, mixerFeedback, 1);
AudioConnection          patchCord85(mixerDelay1, 0, mixerDryWet1, 1);
AudioConnection          patchCord86(mixerDelay2, 0, mixerFeedback, 2);
AudioConnection          patchCord87(mixerDelay2, 0, mixerDryWet2, 1);
AudioConnection          patchCord88(mixerDryWet1, 0, i2s1, 0);
AudioConnection          patchCord89(mixerDryWet2, 0, i2s1, 1);
AudioConnection          patchCord90(mixerDryWet2, peak1);
AudioControlSGTL5000     sgtl5000_1;     //xy=1608,700
...
#define thresh          15000    //KEY THREShOLD SETTING//
...
////////////AUDIO SETUP//////////////
  ...
  //setting up mixers
  mixerKeys1.gain(0, .25);
  mixerKeys1.gain(1, .25);
  mixerKeys1.gain(2, .25);
  mixerKeys1.gain(3, .25);
  mixerKeys2.gain(0, .25);
  mixerKeys2.gain(1, .25);
  mixerKeys2.gain(2, .25);
  mixerKeys2.gain(3, .25);
  mixerKeys3.gain(0, .25);
  mixerKeys3.gain(1, .25);
  mixerKeys3.gain(2, .25);
  mixerKeys3.gain(3, .25);
  mixerKeys4.gain(0, .25);
  mixerKeys4.gain(1, .25);
  mixerKeys4.gain(2, .25);
  mixerKeys4.gain(3, .25);
  mixerFilter1.gain(0, 0);
  mixerFilter1.gain(1, 0);
  mixerFilter1.gain(2, 0);
  mixerFilter1.gain(3, 0.75);
  mixerFeedback.gain(0, 75);
  mixerFeedback.gain(1, 0);
  mixerFeedback.gain(2, 0);
  mixerDryWet1.gain(0, 0.5);
  mixerDryWet2.gain(0, 0.5);
  mixerDryWet1.gain(1, 0.0);
  mixerDryWet2.gain(1, 0.0);
  
  //Initialize waveforms at given frequencies 
  waveformC1.begin(0.3, C2, current_waveform1);
  waveformC2.begin(0.3, C2, current_waveform2);
  waveformC3.begin(0.3, C3, current_waveform3);
  waveformCS1.begin(0.3, CS2, current_waveform1);
  waveformCS2.begin(0.3, CS2, current_waveform2);
  waveformCS3.begin(0.3, CS3, current_waveform3);
  waveformD1.begin(0.3, D2, current_waveform1);
  waveformD2.begin(0.3, D2, current_waveform2);
  waveformD3.begin(0.3, D3, current_waveform3);
  waveformDS1.begin(0.3, DS2, current_waveform1);
  waveformDS2.begin(0.3, DS2, current_waveform2);
  waveformDS3.begin(0.3, DS3, current_waveform3);
  waveformE1.begin(0.3, E2, current_waveform1);
  waveformE2.begin(0.3, E2, current_waveform2);
  waveformE3.begin(0.3, E3, current_waveform3);
  waveformF1.begin(0.3, F2, current_waveform1);
  waveformF2.begin(0.3, F2, current_waveform2);
  waveformF3.begin(0.3, F3, current_waveform3);
  waveformFS1.begin(0.3, FS2, current_waveform1);
  waveformFS2.begin(0.3, FS2, current_waveform2);
  waveformFS3.begin(0.3, FS3, current_waveform3);
  waveformG1.begin(0.3, G2, current_waveform1);
  waveformG2.begin(0.3, G2, current_waveform2);
  waveformG3.begin(0.3, G3, current_waveform3);
  waveformGS1.begin(0.3, GS2, current_waveform1);
  waveformGS2.begin(0.3, GS2, current_waveform2);
  waveformGS3.begin(0.3, GS3, current_waveform3);
  waveformA1.begin(0.3, A2, current_waveform1);
  waveformA2.begin(0.3, A2, current_waveform2);
  waveformA3.begin(0.3, A3, current_waveform3);
  waveformAS1.begin(0.3, AS2, current_waveform1);
  waveformAS2.begin(0.3, AS2, current_waveform2);
  waveformAS3.begin(0.3, AS3, current_waveform3);
  waveformB1.begin(0.3, B2, current_waveform1);
  waveformB2.begin(0.3, B2, current_waveform2);
  waveformB3.begin(0.3, B3, current_waveform3);
...
void loop() {
  ...
  if(buttonState == 5){
    ...
    if(status2.keys == 8){
      ...
      for (int i = 0; i < 12; i++) {
        ...
        tft.fillRect(183, 51, 22, 28, ILI9341_BLACK);
        tft.drawFastHLine(178, 75, map(sliderVal1, 0 , 255, 3, 29), ILI9341_WHITE);
        tft.drawFastVLine(map(sliderVal1, 0, 255, 185, 205), 55, 20, ILI9341_WHITE);
      ...
      for (int i = 0; i < 12; i++) {
        ...
        tft.fillRect(183, 106, 22, 28, ILI9341_BLACK);
        tft.drawFastHLine(178, 130, map(sliderVal2, 0 , 255, 3, 29), ILI9341_WHITE);
        tft.drawFastVLine(map(sliderVal2, 0, 255, 185, 205), 110, 20, ILI9341_WHITE);
      ...
      for (int i = 0; i < 12; i++) {
        ...
        tft.fillRect(183, 161, 22, 28, ILI9341_BLACK);
        tft.drawFastHLine(178, 185, map(sliderVal3, 0 , 255, 3, 29), ILI9341_WHITE);
        tft.drawFastVLine(map(sliderVal3, 0, 255, 185, 205), 165, 20, ILI9341_WHITE);
  ...
  tft.drawRect(280, 70, 20, 120, ILI9341_RED);
  if(sliChange5 == 0){
    tft.fillRect(278, 12, 60, 30, ILI9341_BLACK);
    tft.print(map(wheelVal, 0, 255, 0, 100));
    tft.fillRect(281, 71, 18, 118, ILI9341_BLACK);
    drawSmallKnob(280, map(wheelVal, 0, 255, 182, 70));  
  }
  ...
  // Serial.print(sliChange1);
  // Serial.print("\t");
  // Serial.print(sliChange2);
  // Serial.print("\t");
  // Serial.print(sliChange3);
  // Serial.print("\t");
  // Serial.print(sliChange4);
  // Serial.print("\t");
  // Serial.print(atck);
  // Serial.print("\t");
